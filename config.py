...
class Config:
    ...
    AUTOLITER_MAIL_SENDER = os.environ.get('AUTOLITER_MAIL_SENDER') or "autoLiter <yourqq@qq.com>"
    AUTOLITER_ADMIN = os.environ.get('AUTOLITER_ADMIN') or "yourqq@qq.com"
    AUTOLITER_NOTES_PER_PAGE = 20
